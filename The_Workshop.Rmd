...
The last function we will talk about before discussing how to make this process quicker is the mutate(). This can be used to mutate columns and create new columns. 
