...
Box plot will work the same way but instead of geom_histogram() or geom_point(), it is geom_box plot() and it will use a fill aesthetic argument instead of color. Here we will plot abundance by country
